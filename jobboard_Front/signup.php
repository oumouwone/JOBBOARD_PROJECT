...
if (!empty($_POST)) {
    ...
    $curl = curl_init();
    curl_setopt($curl, CURLOPT_URL, "http://127.1.1.1/php_jobboard_api/App/crud_users/add_user.php");
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="liste-entreprise.html">Découvrir les entreprises </a>
                </li>
                <li class="nav-item ">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a class="nav-link active mr-sm-2 text-info invisible" href="register.html">Connexion</a>
                <a class="btn btn-outline-info btn-bg rounded-pill my-2 my-sm-0" href="job-form.html">Poster un job</a>
            </form>
        </div>
    </nav>
    <!--END HERE-->
                        ...
                        <div class="card-body">
                            ...
                            <form action="signup.php" method="POST">
                                <div class="form-group mb-3">
                                    <label for="exampleInputNom1" class="h4 text-dark">Nom</label>
                                    <input type="text" name="first_name" class="form-control" id="exampleInputNom1" aria-describedby="emailHelp" placeholder="nom"required>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="exampleInputNom1" class="h4 text-dark">Prénom (s)</label>
                                    <input type="text" name="last_name" class="form-control" placeholder="prénom" required>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    <label for="exampleInputNom1" class="h4 text-dark"> Type User</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-outline-info btn-block px-4">S'inscire</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card text-white bg-info py-5 d-md-down-none" style="width:44%;">
                        <div class="card-body text-center">
                            <div>
                                ...
                                <p>Déjà membre ?</p>
                                <a href="register.html" class="btn btn-info active mt-0">Se connecter</a>
                            </div>
                        </div>
                    </div>
                </div>
